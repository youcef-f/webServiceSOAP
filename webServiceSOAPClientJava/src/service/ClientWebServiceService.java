 ...
 * 
 */
@WebServiceClient(name = "ClientWebServiceService", targetNamespace = "http://service/", wsdlLocation = "http://192.168.10.1:8585/CWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTWEBSERVICESERVICE_QNAME = new QName("http://service/", "ClientWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.10.1:8585/CWS?wsdl");
    ...
    public ClientWebService getClientWebServicePort() {
        return super.getPort(new QName("http://service/", "ClientWebServicePort"), ClientWebService.class);
    }
    ...
    public ClientWebService getClientWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "ClientWebServicePort"), ClientWebService.class, features);
    }
